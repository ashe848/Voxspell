...
public class LevelStats extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LevelStats frame = new LevelStats();
	...
	public LevelStats() {
		...
		JButton Title = new JButton("By Level for Current Sessions");
		...
		comboBox.setBounds(1189, 293, 127, 50);
